...
class TradeBotUtils:
    ...
    @classmethod
    def get_instance(cls, logmanager, coinbase_api, exchange_client, ccxt_api, alerts):
        """
        Singleton method to ensure only one instance of TradeBotUtils exists.
        """
        if cls._instance is None:
            cls._instance = cls(logmanager, coinbase_api, exchange_client, ccxt_api, alerts)
        return cls._instance

    def __init__(self, logmanager, coinbase_api, exchange_client, ccxt_api, alerts):
        """
