#!/usr/bin/env python3
"""
Single 180-day backtest runner with Phase 2.3.2 diagnostics

Usage:
    python3 run_single_180d.py [--compression-on|--compression-off] [--stagec-on] [--runner-compressed X] [--runner-normal X] [--trail-compressed X] [--trail-normal X]
...
def run_single_180d(
    ...
    """
    Run single 180-day backtest with Phase 2.3.2 diagnostics
    ...
    print("=" * 80)
    print(f"SINGLE 180-DAY BACKTEST RUN (Phase 2.3.2)")
    print("=" * 80)
    print()
...
if __name__ == "__main__":
    ...
    while i < len(sys.argv):
        ...
        if arg in ["--compression-off", "--off", "-off"]:
            ...
            print("Example: python3 run_single_180d.py --compression-on --stagec-on --runner-compressed 0.20 --runner-normal 0.15 --trail-compressed 2.2 --trail-normal 1.8")
            sys.exit(1)
