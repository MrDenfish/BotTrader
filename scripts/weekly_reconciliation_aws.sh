#!/bin/bash
#
# Weekly Exchange Reconciliation (AWS Server Version)
#
# This script runs weekly to detect missing trades from the database
# by comparing against Coinbase exchange data.
#
# Schedule: Every Sunday at 9:15 AM (after daily reports and validation)
# Cron: 15 9 * * 0 /opt/bot/scripts/weekly_reconciliation_aws.sh
#
