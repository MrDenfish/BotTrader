...
### Currently Live (as of 2026-07-29)
- Composite scoring paper bot on Kraken, unchanged — now serving as a regime instrument rather than a deployment candidate (see 2026-07-27/28 changelog: three strategy families evaluated against pre-registered validation; none passed for the current era)
